...
func NewListNixCachesRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v1/nix/caches")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewListSeedsRequest(server string, params *ListSeedsParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v1/seeds")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewLatestSeedRequest(server string, params *LatestSeedParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v1/seeds/latest")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetSeedRequest(server string, sid string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v1/seeds/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
