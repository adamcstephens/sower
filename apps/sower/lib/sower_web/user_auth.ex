defmodule SowerWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    user_token && Accounts.User.delete_session_token(user_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      SowerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule SowerWeb.PageLive do
        use SowerWeb, :live_view

        on_mount {SowerWeb.UserAuth, :mount_current_user}
        ...
      end
