defmodule Garden.SeedTest do
  ...
  describe "activate/1" do
    test "returns noop when activation is disabled" do
      Application.put_env(:garden, :enable_activation, false)
      on_exit(fn -> Application.put_env(:garden, :enable_activation, true) end)
    ...
    test "uses socket when available" do
      ...
      Application.put_env(:garden, :activator_socket, socket_path)

      on_exit(fn ->
        Application.delete_env(:garden, :activator_socket)
